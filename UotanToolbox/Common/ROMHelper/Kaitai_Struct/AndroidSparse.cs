    ...
    public partial class AndroidSparse : KaitaiStruct
    {
        ...
        public partial class FileHeader : KaitaiStruct
        {
            ...
            public Version Version
            {
                get
                {
                    if (f_version)
                        return _version;
                    _version = M_Root.HeaderPrefix.Version;
                    f_version = true;
                    return _version;
                }
            }
            ...
            public ushort LenHeader
            {
                get
                {
                    if (f_lenHeader)
                        return _lenHeader;
                    _lenHeader = M_Root.HeaderPrefix.LenHeader;
                    f_lenHeader = true;
                    return _lenHeader;
                }
            }
        ...
        public partial class Chunk : KaitaiStruct
        {
            ...
            public partial class ChunkHeader : KaitaiStruct
            {
                ...
                public ChunkHeader(KaitaiStream p__io, Chunk p__parent = null, AndroidSparse p__root = null) : base(p__io)
                {
                    m_parent = p__parent;
                    m_root = p__root;
                    f_lenBody = false;
                ...
                private void _read()
                {
                    _chunkType = (ChunkTypes)m_io.ReadU2le();
                ...
                public int LenBodyExpected
                {
                    get
                    {
                        ...
                        _lenBodyExpected = (int)(ChunkType == ChunkTypes.Raw ? (int)M_Root.Header.BlockSize * NumBodyBlocks : ChunkType == ChunkTypes.Fill ? 4 : ChunkType == ChunkTypes.DontCare ? 0 : ChunkType == ChunkTypes.Crc32 ? 4 : -1);
        ...
        public partial class Version : KaitaiStruct
        {
            ...
            public Version(KaitaiStream p__io, FileHeaderPrefix p__parent = null, AndroidSparse p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private AndroidSparse m_root;
            private FileHeaderPrefix m_parent;
            public ushort Major { get { return _major; } }
            public ushort Minor { get { return _minor; } }
            public AndroidSparse M_Root { get { return m_root; } }
            public FileHeaderPrefix M_Parent { get { return m_parent; } }
        }
