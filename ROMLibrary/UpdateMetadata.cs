...
namespace ChromeosUpdateEngine
{
...
#endif
    {
      ...
      if (_unknownFields != null) {
        ...
        void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output)
        {
            installOperations_.WriteTo(ref output, _repeated_installOperations_codec);
            kernelInstallOperations_.WriteTo(ref output, _repeated_kernelInstallOperations_codec);
            if (HasBlockSize)
            {
                output.WriteRawTag(24);
                output.WriteUInt32(BlockSize);
        ...
        void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input)
        {
            ...
            while ((tag = input.ReadTag()) != 0)
            {
                ...
                switch (tag)
                {
                    ...
                    case 10:
                        {
                            installOperations_.AddEntriesFrom(ref input, _repeated_installOperations_codec);
                            break;
                        }
                    case 18:
                        {
                            kernelInstallOperations_.AddEntriesFrom(ref input, _repeated_kernelInstallOperations_codec);
                            break;
                        }
                    case 24:
                        {
