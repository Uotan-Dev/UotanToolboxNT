...
namespace UotanToolbox.Common.QcomHelper.modules
{
    ...
    internal class OnePlusDevice(string fh, string projid, int version, int serial, int atoBuild, int flashMode, int cf, string[] supported_functions)
    {
        ...
        public static OnePlusDevice Init(string projid, int serial, int atoBuild = 0, int flashMode = 0, int cf = 0)
        {
            OnePlusDevice oneplus = new OnePlusDevice("", "18825", 1, 123456, 0, 0, 0, null);
