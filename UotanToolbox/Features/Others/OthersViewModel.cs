...
public partial class OthersViewModel : MainPageBase
{
    ...
    public OthersViewModel() : base(GetTranslation("Sidebar_Others"), MaterialIconKind.WrenchCogOutline, 200, "显示属性电池模拟非充电模拟无线充电模拟USB充电模拟直流充电锁屏时间图标隐藏字体调节动画速度窗口缩放过渡缩放动画时长")
    {
    }
}